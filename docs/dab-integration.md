...
**Leaderboard standing (current, 2026-08-04):** LabRat has **three accepted entries** plus one pending. Accepted: "GPT-5.6-Luna-Max + Cartographer" **74.18%** (PR #72, 2026-07-16 — the current citable number; #2 among untuned-prompt entries), "Claude-Sonnet-4.6 + Cartographer" 60.88% (PR #65), "Claude-Sonnet-4.6" 51.38% (PR #54, historical). **Pending: PR #84 (submitted 2026-08-04) — "Claude Opus 5 + Cartographer + informed packs", 0.810150 stratified, Tuned-prompt row, 268/270 with 2 disclosed infra exclusions; do not claim its rank until accepted.** Never cite the contaminated 58.0% figure. DAB scores are versioned against the **current ground truth**: the leaderboard re-scores all rows when GTs/validators change (patents PR #59 precedent; most recently the tightened crmarenapro:9 validator, against which the PR #84 answers were re-verified before submission). Results/history/conclusions: `dab-progress-report.md`.
