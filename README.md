...
LabRat is measured on the two most serious public **agentic** data benchmarks — both execution-based (real databases, real validators, no LLM judges).
