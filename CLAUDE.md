...
Current tools (16): `build_data_tools_registry()` registers 11 — `profile_dataset`, `list_tables`, `describe_table`, `search_columns`, `sample_rows`, `column_stats`, `run_sql`, `explain_sql`, `attach_database`, `load_file`, `load_mongo_collection`. The TUI additionally registers 5 — `draft_sql`, `create_chart` (callbacks) and `run_validations`, `recall_memories`, `search_query_history` (profile-keyed).
